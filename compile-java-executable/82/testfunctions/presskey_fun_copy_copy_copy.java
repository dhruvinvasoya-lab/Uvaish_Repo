...
class presskey_fun_copy_copy_copy {

	public static void presskey_fun_copy_copy_copy() {
		tg.navigateToUrl("https://keyboard-tester.com/");
		tg.wait(2);
		// [DISABLED] START_CUSTOM_SCRIPT;
		// [DISABLED] System.out.println("FName " + FirstName);
		// [DISABLED]             System.out.println("LName " + LastName);
		// [DISABLED]             var_TGReturn = FirstName + " " + LastName + " " + amount;
		// [DISABLED]             System.out.println("Full Name " + var_TGReturn);
		...
		// [DISABLED] tg.networkAssert("networkassert");
				var_name = tg.readFromAPI("req1_api.json").getString();
