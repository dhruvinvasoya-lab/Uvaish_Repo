...
public class web_codeless_try {

    public static String var_glbvar = "Globle";
    ...
    public void case1tgit01() {
        ...
        tg.wait("ele_lastname015", ComparisonType.IS_CLICKABLE, 10);
        tg.click("ele_lastname015", 1);
        tg.type("ele_lastname015", "Uvaish");
        String var_email = "";
        var_email = tg.saveToVariable("uvaish@test.com", var_email);
        tg.writeToCSV("var_email", var_email, "");
        // [DISABLED] String var_email = "testgrid@gmail.com";
        tg.click("ele_nameexampl862", 1);
        tg.type("ele_nameexampl862", var_email);
    ...
    public void case1tgit02() {
        ...
        tg.wait("ele_lastname015", ComparisonType.IS_CLICKABLE, 10);
        tg.click("ele_lastname015", 1);
        tg.type("ele_lastname015", "Rahul");
        String var_email = "";
        var_email = tg.saveToVariable("rahul@gmail.com", var_email);
        tg.writeToCSV("var_email", var_email, "");
        // [DISABLED] String var_email = "testgrid@gmail.com";
        tg.click("ele_nameexampl862", 1);
        tg.type("ele_nameexampl862", var_email);
    ...
    public void case1tgit03() {
        ...
        tg.wait("ele_lastname015", ComparisonType.IS_CLICKABLE, 10);
        tg.click("ele_lastname015", 1);
        tg.type("ele_lastname015", "Amit");
        String var_email = "";
        var_email = tg.saveToVariable("amit@yahoo.com", var_email);
        tg.writeToCSV("var_email", var_email, "");
        // [DISABLED] String var_email = "testgrid@gmail.com";
        tg.click("ele_nameexampl862", 1);
        tg.type("ele_nameexampl862", var_email);
